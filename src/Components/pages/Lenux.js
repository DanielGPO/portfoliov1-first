...
function Lenux() {
  return (
   ...
   >-Lenux-</h3>
    ...
    <div className='bg-black/30  text-white mt-10 xl:w-[500px] w-[475px] ml-2 h-[560px] rounded-xl lg:top-12 lg:sticky lg:right-0'>
    ...
    <p className='text-2xl font-bold'>Resumo:</p>
      <p className='font-semibold'>Um dos meus primeiros projetos no HTML, tinha o intuito de usar Grid e Flexbox na prática, encontrei esse design em um site chamado NicePage e me apaixonei por ele. A maior dificuldade
