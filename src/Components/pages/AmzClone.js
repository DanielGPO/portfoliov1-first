  ...
  return (
   ...
   >-Amazon Clone-</h3>
    ...
    <p className='text-2xl font-bold'>Resumo:</p>
      <p className='font-semibold'>Esse projeto se mostrou ser bem tranquilo de ser feito com a ajuda da Fakestore API e Redux. Não tive grandes dificuldades nem fiquei preso por horas resolvendo erros, oque costumava acontecer
