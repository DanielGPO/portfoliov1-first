...
function Skills() {
  return (
    <div className='sm:h-screen w-[500px] md:w-full mt-[60px] sm:mt-0 h-[1080px] relative'>

          <div className=' flex flex-col ml-[180px] lg:ml-[600px] md:ml-[350px]'>
          <h3 className='uppercase py-10 tracking-[20px] text-gray-500 text-2xl'
          >Skills
          </h3>
          </div>
         ...
         >
           <div className='absolute w-full h-full bg-black/60 opacity-0 hover:opacity-100 text-white rounded-full'><p className='absolute right-0 text-2xl pt-10 pr-10'>Finalizado</p></div>
            <img
         ...
         <div className='relative '>
            <div className='absolute w-full h-full bg-black/60 opacity-0 hover:opacity-100 text-white rounded-full'><p className='absolute right-0 text-2xl pt-10 pr-10'>Progresso: 78%</p></div>
            <img
            className='rounded-full border border-gray-500 object-cover w-24 h-24  xl:w-32
             xl:h-32  filter  hover:grayscale'
         ...
         <div className='relative'>
            <div className='absolute w-full h-full bg-black/60 opacity-0 hover:opacity-100 text-white rounded-full'><p className='absolute right-0 text-2xl pt-10 pr-10'>Progresso: 82%</p></div>
            <img
            className='rounded-full border border-gray-500 object-cover w-24 h-24  xl:w-32
             xl:h-32 filter  hover:grayscale'
